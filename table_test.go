...
func TestNewTable(t *testing.T) {
	...
	assert.Equal(t, table.Fields[0].SQL.TypeArg, "11")
	...
	assert.Equal(t, table.Fields[1].SQL.TypeArg, "255")
	...
	assert.Equal(t, table.Fields[2].SQL.TypeArg, "")
	...
	assert.Equal(t, table.Fields[3].SQL.TypeArg, "255")
	...
	assert.Equal(t, table.Fields[5].SQL.TypeArg, "20")
}
